...
export const influencers: Influencer[] = [
  ...
  },
  {
    ...
    "category": "Handwerk & DIY",
    "followers": "163K",
    "imageUrl": "https://ui-avatars.com/api/?name=Mike%20Imos&background=random",
    "bio": "",
    "platforms": [
      "TikTok"
    ],
  ...
  },
  {
    ...
    "category": "Handwerk & DIY",
    "followers": "33K",
    "imageUrl": "https://ui-avatars.com/api/?name=Dachdeckerin%20Fabienne&background=random",
    "bio": "",
    "platforms": [
      "TikTok"
    ],
  ...
  },
  {
    ...
    "category": "Handwerk & DIY",
    "followers": "146K",
    "imageUrl": "https://ui-avatars.com/api/?name=Rene%20Lang&background=random",
    "bio": "",
    "platforms": [
      "TikTok"
    ],
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    stats: [
      { label: 'Focus', value: 'B2B Innovation' },
      { label: 'Channel', value: 'Instagram/TikTok' }
    ],
  ...
  },
  {
    ...
    stats: [
      { label: 'Scope', value: '3 Videos' },
      { label: 'Phase', value: 'Strategy & Creation' }
    ],
  ...
  },
  {
    ...
    stats: [
      { label: 'Insight', value: '21% Gen-Z Search' },
      { label: 'Format', value: '9:16 Native' }
    ],
  ...
  },
  {
    ...
    stats: [
      { label: 'Clicks', value: '38.5k' },
      { label: 'Metric', value: 'High VTR' },
      { label: 'Product', value: 'Pixel 10 Pro' }
    ],
